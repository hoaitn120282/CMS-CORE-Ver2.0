			...
			<div class="row">
				<div class="col-md-3 col-sm-4 col-xs-12">
					<div class="default-widget">
						...
						<?php foreach($default as $key => $value): ?>
							<?php echo $__env->make('ContentManager::widget.partials.selectwidget',['group'=>'default'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>  
						<?php endforeach; ?>
						</div>
					</div>
					<div class="default-widget">
						...
						<?php foreach($theme as $key => $value): ?>
							<?php echo $__env->make('ContentManager::widget.partials.selectwidget',['group'=>'theme'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>  
						<?php endforeach; ?>
						</div>
					</div>
				</div>
				<div class="col-md-9 col-sm-8 col-xs-12">
					<div class="default-widget">
						...
						<div class="content">
							<div class="row">
							<?php foreach($widgetGroups as $gr): ?>
							<div class="col-md-6 col-sm-6 col-xs-12">
								<div class="panel panel-default">
									<div class="panel-heading">
										<?php echo e(ucwords(str_replace("_"," ",$gr->name))); ?>

									</div>
									<div class="panel-body">
										<ol id="con-menu" class="sortable" style="padding-left:0;background:#eee">
								    	<?php foreach($gr->widget() as $widget): ?>
									 		<?php echo $__env->make('ContentManager::widget.partials.form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>  
									 	<?php endforeach; ?>
								    	</ol>
									</div>
								</div>
...
<link rel="stylesheet" href="<?php echo e(url('/assets/jquery.ui')); ?>/jquery-ui.css" />
<style type="text/css">
	.placeholder {
...
<script type="text/javascript" src="<?php echo e(url('/assets/js')); ?>/jquery.mjs.nestedSortable.js"></script>
<script>
$( document ).ready(function() {
	var ns = $('ol.sortable').nestedSortable({
		...
		stop: function() { 
			...
			$.ajax({
	              type: 'POST',
	              url: "<?php echo e(Admin::route('contentManager.widget.reorder')); ?>",
	              data: {"_token": "<?php echo e(csrf_token()); ?>","datawidget":te}
	          })
	        .done(function() {
	...
	$("a[data-role='saveWidget']").on( "click", function() {
        ...
        $.ajax({
                type: 'POST',
                url: "<?php echo e(Admin::route('contentManager.widget.store')); ?>",
                data: {"_token": "<?php echo e(csrf_token()); ?>","widget":tmp}
            })
          .done(function() {
    ...
    $("a[data-role='toggle-menu']").on( "click", function() {
  	...
  	$("a[data-role='add-widget']").on( "click", function() {
	    ...
	    $.ajax({
                type: 'POST',
                url: "<?php echo e(Admin::route('contentManager.widget.addWidget')); ?>",
                data: {"_token": "<?php echo e(csrf_token()); ?>","className":className,"position":position}
            })
          .done(function() {
            location.reload();
        });
