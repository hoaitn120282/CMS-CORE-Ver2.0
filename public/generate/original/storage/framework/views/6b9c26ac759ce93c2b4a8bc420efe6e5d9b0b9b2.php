        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                <div class="x_panel">
                    ...
                    <?php echo $__env->make('TemplateManager::components.alert', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                    <div class="x_content">
                        ...
                        <form id="install_theme" name="install_theme"
                              action="<?php echo e(Admin::route('contentManager.theme.install')); ?>"
