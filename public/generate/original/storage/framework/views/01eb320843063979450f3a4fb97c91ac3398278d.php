...
<title>Simple Site Title | <?php echo $__env->yieldContent('title'); ?></title>
<body>
            ...
            <div>
                ...
                <div class="navbar-header">
                    ...
                    <ul class="navbar-brand list-inline" >
                            <li>
                                <a href="?page=index">
                                    <img class="logo" src="<?php echo e(URL::to("/themes/{$folder}")); ?>/images/logo.png" alt="">
                                </a>
                            </li>
                            <li class="sologan">
                                <a href="?page=index">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right nav-right-custom text-right">
                        <li><a href="?page=index" class="<?php echo e(('index' == Request::get('page', 'index')) ? 'active' : ''); ?>">Home</a></li>
                        <li><a href="?page=info"  class="<?php echo e(('info' == Request::get('page')) ? 'active' : ''); ?>">INFO FOR PATIENT</a></li>
                        <li><a href="?page=contact"  class="<?php echo e(('contact' == Request::get('page')) ? 'active' : ''); ?>">Contact</a></li>
