...
namespace App\Widgets\Sanmax58c6719869c04;
...
class LightSliderWidget extends BaseWidget
{
    ...
    public function form(){
        ...
        return \View::make('widgets.Sanmax58c6719869c04.LightSliderWidget.form', [
            'options' => $this->options, 'model' => $model, 'galleries' => $galleries, 'theme'=>"Sanmax58c6719869c04", 'widget'=>"LightSliderWidget"
        ])->render();
    }
    ...
    public function run(){
        ...
        return \View::make('widgets.Sanmax58c6719869c04.LightSliderWidget.run', ['model' => $model, 'options' => $this->options])->render();
    }
}