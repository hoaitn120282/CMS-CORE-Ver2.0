...
namespace App\Widgets\Sanmax58ca5e4c07f53;
...
class LightSliderWidget extends BaseWidget
{
    ...
    public function form(){
        ...
        return \View::make('widgets.Sanmax58ca5e4c07f53.LightSliderWidget.form', [
            'options' => $this->options, 'model' => $model, 'galleries' => $galleries, 'theme'=>"Sanmax58ca5e4c07f53", 'widget'=>"LightSliderWidget"
        ])->render();
    }
    ...
    public function run(){
        ...
        return \View::make('widgets.Sanmax58ca5e4c07f53.LightSliderWidget.run', ['model' => $model, 'options' => $this->options])->render();
    }
}