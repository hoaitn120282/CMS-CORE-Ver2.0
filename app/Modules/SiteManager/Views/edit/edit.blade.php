                        ...
                        <div class="col-sm-7">
                            <div class="information">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="domain" name="domain" value="{{ $clinic->domain }}"  placeholder="Domain">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group infor-child">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="host" name="host" value="{{ $clinic->hosting->host }}"  placeholder="Host">
                                        ...
                                        <div class="form-group infor-child">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="host-username" name="host-username" value="{{ $clinic->hosting->username }}"  placeholder="Username">
                                        ...
                                        <div class="form-group infor-child">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="password" class="form-control" id="host-password" name="host-password" value="{{ $clinic->hosting->password }}"  placeholder="Password">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group infor-child">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="database-name" name="database-name" value="{{ $clinic->database->database_name }}"  placeholder="Name">
                                        ...
                                        <div class="form-group infor-child">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" name="database-host" id="database-host" value="{{ $clinic->database->host }}"  placeholder="Host">
                                        ...
                                        <div class="form-group infor-child">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="database-username" name="database-username"  value="{{ $clinic->database->username }}" placeholder="Username">
                                        ...
                                        <div class="form-group infor-child">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="password" class="form-control" id="database-password" name="database-password" value="{{ $clinic->database->password }}"  placeholder="Password">
