            ...
            <li>
                <a id="btn-sel-del" style="display:none;"
                   ...
                   class="btn btn-danger btn-xs">
                    <i class="fa fa-trash"></i> Delete Selected tag
                </a>
            <li>
                <a href="{{ Admin::route('contentManager.tag.create') }}" class="btn-toolbox success">
                    <i class="fa fa-plus"></i> Create tag</a>
            </li>
        </ul>
        ...
        <table class="table table-striped jambo_table bulk_action">
            ...
            @foreach ($nodes as $data)
                <tr id="tr-{{ $data->term_id }}" class="icheck">
                    ...
                    <td>{{$data->slug}}</td>
                    <td class="action">
                        <a href="{{ Admin::route('contentManager.tag.edit',['post'=>$data->term_id]) }}" class="text-success">
