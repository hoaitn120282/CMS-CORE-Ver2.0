                ...
                <form action="{{ Admin::route('contentManager.setting.update') }}" method="POST">
                    ...
                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
                        <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                            <li role="presentation" class="active"><a href="#tab_content1" id="general-tab" role="tab"
                                                                      data-toggle="tab" aria-expanded="true">Home</a>
                            </li>
                            <li role="presentation" class=""><a href="#tab_content2" role="tab" id="post-tab"
                                                                data-toggle="tab" aria-expanded="false">Post</a>
                            </li>
                            <li role="presentation" class=""><a href="#tab_content3" role="tab" id="media-tab2"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="opt[image_thumbnail_height]" class="form-control"
                                                   value="{{ $model['image_thumbnail_height'] }}"
                                                   id="image_thumbnail_height" placeholder="Site Tagline">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="opt[image_medium_width]" class="form-control"
                                                   value="{{ $model['image_medium_width'] }}" id="image_medium_width"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="opt[image_medium_height]" class="form-control"
                                                   value="{{ $model['image_medium_height'] }}" id="image_medium_height"
                                                   placeholder="Site Tagline">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="opt[image_large_width]" class="form-control"
                                                   value="{{ $model['image_large_width'] }}" id="image_large_width"
                                                   placeholder="Site Title">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="opt[image_large_height]" class="form-control"
                                                   value="{{ $model['image_large_height'] }}" id="image_large_height"
                                                   placeholder="Site Tagline">
                                        </div>
                                    </div>
                                </div>
