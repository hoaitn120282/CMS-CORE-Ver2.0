...
<header class="header">
            ...
            <div>
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right nav-right-custom text-right">
                        ...
                        <li><a href="#">INFO FOR PATIENT</a></li>
    ...
    <div class="header-banner">
        <div class="slide-item"
             style="background: url({{ URL::to('/themes/clinic_simple/images/banner.jpg') }}) no-repeat center center; height: 350px; background-size: cover;">
        </div>
    </div>
    <!--End Slide-->
</header>
...
<script type="text/javascript" src="{{URL::to('/themes/clinic_simple')}}/js/plugin/jquery.min.js"></script>
<script type="text/javascript" src="{{URL::to('/themes/clinic_simple')}}/js/plugin/bootstrap.min.js"></script>
<script type="text/javascript" src="{{URL::to('/themes/clinic_simple')}}/js/plugin/lightslider.min.js"></script>
<script type="text/javascript" src="{{URL::to('/themes/clinic_simple')}}/js/plugin/jquery.appear.js"></script>
<script type="text/javascript" src="{{URL::to('/themes/clinic_simple')}}/js/plugin/owl.carousel.min.js"></script>

<script type="text/javascript" src="{{URL::to('/themes/clinic_simple')}}/js/main.js"></script>
