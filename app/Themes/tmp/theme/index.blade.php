...
<head>
    ...
    <link rel="stylesheet" href="{{URL::to('/themes/simple')}}/css/bootstrap/bootstrap.min.css">
    <link rel="stylesheet" href="{{URL::to('/themes/simple')}}/css/font-awesome/css/font-awesome.min.css">
    <link rel="stylesheet" href="{{URL::to('/themes/simple')}}/css/owl.carousel/dist/assets/owl.carousel.min.css" />
    <link rel="stylesheet" href="{{URL::to('/themes/simple')}}/css/lightslider/lightslider.min.css" />
    <link rel="stylesheet" href="{{URL::to('/themes/simple')}}/css/main.css">
...
<header class="header">
        ...
        <div class="container">
            <div>
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand io-logo" href="#"><img src="{{URL::to('/themes/simple')}}/images/logo.png"></a>
                </div>
    ...
    <div class="header-banner">
        <div class="slide-item" style="background: url({{URL::to('/themes/simple')}}/images/banner.jpg) no-repeat center center; height: 350px; background-size: cover;">
        </div>
    </div>
    <!--End Slide-->
</header>
            ...
            <div class="col-md-9 col-sm-12">
                <section class="content-dt">
                    <ul id="lightSlider" class="gallery list-unstyled cS-hidden">
                        <li data-thumb="{{URL::to('/themes/simple')}}/images/content-img.jpg">
                            <img src="{{URL::to('/themes/simple')}}/images/content-img.jpg" />
                        </li>
                        <li data-thumb="{{URL::to('/themes/simple')}}/images/content-img.jpg">
                            <img src="{{URL::to('/themes/simple')}}/images/content-img.jpg" />
                        </li>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-6">
                            <div class="make-appointment">
                                <figure>
                                    <img src="{{URL::to('/themes/simple')}}/images/doctor-1.jpg" alt="">
                                </figure>
                                <header>
                                    <h4>Dr. Anna Doe</h4>
                                    <p>Sample Position</p>
                        ...
                        <div class="col-md-12 col-sm-6">
                            <div class="make-appointment">
                                <figure>
                                    <img src="{{URL::to('/themes/simple')}}/images/doctor-2.jpg" alt="">
                                </figure>
                                <header>
                                    <h4>Dr. Anna Doe</h4>
                                    <p>Sample Position</p>
